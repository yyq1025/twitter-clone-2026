  ...
  return (
    <>
      <div className="border-b px-4">
        ...
        <div className="flex items-center gap-1 border-t py-2">
          <div className="flex-1">
            <Button className="group flex cursor-pointer items-center gap-1 text-muted-foreground hover:text-blue-600">
      ...
      <div className="border-b">
        <Button className="flex size-full items-center gap-2 px-4 py-3 hover:bg-muted">
          <Avatar size="sm">
            <AvatarImage
